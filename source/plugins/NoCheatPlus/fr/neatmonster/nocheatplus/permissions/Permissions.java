...
public class Permissions {
   ...
   public static final String ADMINISTRATION_BAN = "nocheatplus.admin.ban";
   public static final String ADMINISTRATION_DELAY = "nocheatplus.admin.delay";
   public static final String ADMINISTRATION_EXEMPT = "nocheatplus.admin.exempt";
   public static final String ADMINISTRATION_UNEXEMPT = "nocheatplus.admin.unexempt";
   public static final String ADMINISTRATION_EXEMPTIONS = "nocheatplus.admin.exemptions";
   public static final String ADMINISTRATION_INFO = "nocheatplus.admin.info";
   public static final String ADMINISTRATION_COMMANDS = "nocheatplus.admin.commands";
   public static final String ADMINISTRATION_KICK = "nocheatplus.admin.kick";
   public static final String ADMINISTRATION_KICKLIST = "nocheatplus.admin.kicklist";
   public static final String ADMINISTRATION_LAG = "nocheatplus.admin.lag";
   public static final String ADMINISTRATION_NOTIFY = "nocheatplus.admin.notify";
   public static final String ADMINISTRATION_PLUGINS = "nocheatplus.admin.plugins";
   public static final String ADMINISTRATION_RELOAD = "nocheatplus.admin.reload";
   public static final String ADMINISTRATION_REMOVEPLAYER = "nocheatplus.admin.removeplayer";
   public static final String ADMINISTRATION_TELL = "nocheatplus.admin.tell";
   public static final String ADMINISTRATION_TEMPKICK = "nocheatplus.admin.tempkick";
   public static final String ADMINISTRATION_UNKICK = "nocheatplus.admin.unkick";
   public static final String ADMINISTRATION_VERSION = "nocheatplus.admin.version";
   ...
   public static final String FEATURE_COMMAND_NOCHEATPLUS = "feature.command.nocheatplus";
